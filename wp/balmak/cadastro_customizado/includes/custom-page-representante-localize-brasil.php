...
class nix_representante_br{
	...
	public static function pegaHtmlCadastro($_ID=""){
		...
		if( is_numeric($_ID) ){
			...
			$rb_id = $arr_info["rb_id"];
			$rb_nome = $arr_info["rb_nome"];
			$rb_telefone1 = $arr_info["rb_telefone1"];
			$rb_telefone2 = $arr_info["rb_telefone2"];
			$rb_telefone3 = $arr_info["rb_telefone3"];
			$rb_email = $arr_info["rb_email"];
			$rb_contato = $arr_info["rb_contato"];
			$rb_area_de_atuacao = $arr_info["rb_area_de_atuacao"];
			$rb_area_atua = $arr_info["rb_area_atua"];
			$rb_estado = $arr_info["rb_estado"];
		}
		else{
			$rb_id = "";
			$rb_nome = "";
	...
	public static function salvaDados($arr_dados){
		...
		if(is_numeric($arr_dados["id"])){
			$sql = "UPDATE $v_nome_tabela SET rb_nome = '".mysql_real_escape_string($arr_dados["rb_nome"])."',
																				...
																				rb_telefone2 = '".mysql_real_escape_string($arr_dados["rb_telefone2"])."',
																				rb_telefone3 = '".mysql_real_escape_string($arr_dados["rb_telefone3"])."',
																				rb_email = '".mysql_real_escape_string($arr_dados["rb_email"])."',
																				rb_contato = '".mysql_real_escape_string($arr_dados["rb_contato"])."',
																				rb_area_de_atuacao = '".mysql_real_escape_string($arr_dados["rb_area_de_atuacao"])."',
																				rb_area_atua = '".mysql_real_escape_string($arr_dados["rb_area_atua"])."',
																				rb_estado = '".mysql_real_escape_string($arr_dados["rb_estado"])."'
							WHERE rb_id = " . $arr_dados["id"];
		}
		else{
			$sql = "INSERT INTO $v_nome_tabela(rb_nome, rb_telefone1, rb_telefone2, rb_telefone3, rb_email, rb_contato, rb_area_de_atuacao, rb_area_atua, rb_estado) VALUES ('".mysql_real_escape_string($arr_dados["rb_nome"])."', '".mysql_real_escape_string($arr_dados["rb_telefone1"])."', '".mysql_real_escape_string($arr_dados["rb_telefone2"])."', '".mysql_real_escape_string($arr_dados["rb_telefone3"])."', '".mysql_real_escape_string($arr_dados["rb_email"])."', '".mysql_real_escape_string($arr_dados["rb_contato"])."', '".mysql_real_escape_string($arr_dados["rb_area_de_atuacao"])."', '".mysql_real_escape_string($arr_dados["rb_area_atua"])."', '".mysql_real_escape_string($arr_dados["rb_estado"])."')";
		}
