      ...
      <div class="col span_3_of_4">
          ...
          <div class="blog-item">
            ...
            <div class="meta-top">
              ...
              <div class="data">
                <span style="font-size: 26px !important; position: relative; top: 4px;" class="balmak-title-red">de <?php echo $V_STR_MES; ?></span>
                <!--
                <br />
            ...
            */
            ...
            <div class="body">
              ...
              <p style="text-align:left;"><a href="<?php echo get_permalink($V_ID); ?>">Veja mais ....</a></p>
            </div>
