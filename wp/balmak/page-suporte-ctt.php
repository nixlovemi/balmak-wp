...
<div class="chamada-topo balmak-border-bottom-red" data-img="<?php echo esc_url( get_template_directory_uri() ); ?>/images/chamada-suporte-ctt.jpg">
	<div class="chamada-topo-txt"><span>Centro de Treinamento</span></div>
</div>
<div class="content">
  <div class="main-width">
  	<?php
		$ctt_titulo = simple_fields_values("page_centro_treinamento_tec_1_titulo");
		$ctt_conteudo = simple_fields_values("page_centro_treinamento_tec_1_conteudo");
		
		// monta array com infos
		$arr_info_atab = array();
		for($i=0; $i<count($ctt_titulo); $i++){
			$v_titulo = (isset($ctt_titulo[$i])) ? $ctt_titulo[$i]: "";
			$v_conteudo = (isset($ctt_conteudo[$i])) ? $ctt_conteudo[$i]: "";
